 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::ON(uint8_t socket)
{
    uint8_t error;
    _baudrate = 57600;
    _uart = socket;
    ...
    {  
        ...
        // Set multiplexer
        Utils.setMuxSocket0(); //For Multiprotocol v1.0 compatibility 
        Utils.setMUXSocket0(); //For Multiprotocol v2.0
    }
    else
    {   
        _uart = UART0;
        ...
        // Set multiplexer
        Utils.setMuxSocket1(); //For Multiprotocol v1.0 compatibility 
        Utils.setMUXSocket1(); //For Multiprotocol v2.0
    }
 ...
 *  @arg    '0' if OK
 */
uint8_t arduinoLoRaWAN::OFF(uint8_t socket)
{
    if (socket == SOCKET0)
    {  
        _uart = SOCKET0;
        
        // Set multiplexer to default
        Utils.setMuxUSB();     //For Multiprotocol v1.0 compatibility
        Utils.setMUXSocket0(); //For Multiprotocol v2.0
 ...
 *      @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setAppEUI(char* eui)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getAppEUI()
{
    uint8_t status;
    char ans1[50];
 ...
 *      @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setAppKey(char* key)
{
    uint8_t status; 
    char ans1[15];
    char ans2[15];
 ...
 *      @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setAppSessionKey(char* key)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 */
uint8_t arduinoLoRaWAN::setPower(uint8_t index)
{
    uint8_t status; 
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::getPower()
{
    uint8_t status; 
    char ans1[15];
 ...
 *  @arg    '8' if unrecognized module
 */
uint8_t arduinoLoRaWAN::setDataRate(uint8_t datarate)
{
    uint8_t status; 
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::getDataRate()
{
    uint8_t status; 
    char ans1[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::saveConfig()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '3' if keys were not initiated
 */
uint8_t arduinoLoRaWAN::joinOTAA()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 */
uint8_t arduinoLoRaWAN::sendConfirmed(uint8_t port, char* payload)
{
    uint8_t status;
    char ans1[20];
    char ans2[20];
    ...
    if (status == 1)
    {
        ...
        //wait for response
        status = waitFor(ans1, ans2, ans3, ans4, 180000);
 ...
 *  @arg    '7' if input port parameter error
 */
uint8_t arduinoLoRaWAN::sendUnconfirmed(uint8_t port, char* payload)
{
    uint8_t status;
    char ans1[20];
    char ans2[20];
 ...
 *      @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setADR(char* state)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::getDutyCyclePrescaler()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::macPause()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::macResume()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 */
uint8_t arduinoLoRaWAN::setChannelFreq(uint8_t channel, uint32_t freq)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '8' if unrecognized module
 */
uint8_t arduinoLoRaWAN::getChannelFreq(uint8_t channel)
{
    uint8_t status;
    char ans1[50];
 ...
 *  @arg    '8' module does not support function
 */
uint8_t arduinoLoRaWAN::getChannelDutyCycle(uint8_t channel)
{
    uint8_t status;
    char ans1[50];
 ...
 */
uint8_t arduinoLoRaWAN::setChannelDRRange(uint8_t channel, uint8_t minDR, uint8_t maxDR)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::getChannelDRRange(uint8_t channel)
{
    uint8_t status;
    char ans1[50];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::setChannelStatus(uint8_t channel, char* state)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::getChannelStatus(uint8_t channel)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::setRetries(uint8_t retries)
{
    uint8_t status; 
    char ans1[15];
    char ans2[15];
    ...
    sprintf_P(_command,(char*)pgm_read_word(&(table_LoRaWAN_COMMANDS[69])),(uint8_t)retries);

    // create "ok" answer
    sprintf_P(ans1,(char*)pgm_read_byte(&(table_LoRaWAN_ANSWERS[22])));

    // create "invalid_param" answer
    sprintf_P(ans2,(char*)&(table_LoRaWAN_ANSWERS[1]));
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::getRetries()
{
    uint8_t status; 
    char ans1[15];
 ...
 *  @arg    '8' module does not support function
 */
uint8_t arduinoLoRaWAN::getBand()
{
    uint8_t status;
    char ans1[50];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getMargin()
{
    uint8_t status;
    char ans1[50];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getGatewayNumber()
{
    uint8_t status;
    char ans1[50];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setUpCounter(uint32_t counter)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getUpCounter()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setDownCounter(uint32_t counter)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setLinkCheck(uint16_t time)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getDownCounter()
{
    uint8_t status;
    char ans1[15];
 ...
 *      @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::sendRadio(char * message)
{   
    char ans1[15];
    char ans2[15];
    uint8_t status;
 ...
 *
 */
uint8_t arduinoLoRaWAN::receiveRadio(uint32_t timeout)
{
    uint8_t error;  
    uint8_t status; 
    char ans1[15];
 ...
 *      @arg    '2' it no answer
 */
uint8_t arduinoLoRaWAN::test_ON()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *
 */
uint8_t arduinoLoRaWAN::test_OFF()
{
    uint8_t status; 
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::getRadioSNR()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer 
 */
uint8_t arduinoLoRaWAN::setRadioSF(char* sprfact)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
    ...
    // create "invalid_param" answer
    sprintf_P(ans2,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[21])));
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioSF()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::setRadioPower(int8_t pwr)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioPower()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioMode(char* mode)
{
    uint8_t status;
    char ans1[50];
    char ans2[50];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioMode()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::setRadioFreq(uint32_t freq)
{
    uint8_t status;
    char ans1[50];
    char ans2[50];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioFreq()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioReceivingBW(float bandwidth)
{
    uint8_t status;
    char bandw[6];
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioReceivingBW()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setRadioBitRateFSK(uint32_t bitrate)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioBitRateFSK()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setRadioFreqDeviation(uint32_t freqdeviation)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioFreqDeviation()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioCRC(char* state)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioCRC()
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioPreamble(uint16_t length)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioPreamble()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioCR(char* codingrate)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRadioWDT(uint32_t time)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioWDT()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '7' if input parameter error
 */
uint8_t arduinoLoRaWAN::setRadioBW(uint16_t bandwidth)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::getRadioBW()
{
    uint8_t status;
    char ans1[15];
 ...
 *  @arg    '8' unrecognized module
 */
uint8_t arduinoLoRaWAN::setRX2Parameters(uint8_t datarate, uint32_t frequency)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 *  @arg    '2' if no answer
 */
uint8_t arduinoLoRaWAN::setRX1Delay(uint16_t delay)
{
    uint8_t status;
    char ans1[15];
    char ans2[15];
 ...
 */
uint32_t arduinoLoRaWAN::parseValue(uint8_t base)
{
    char * pch;
    pch = strtok((char*) _buffer," \r\n");
    if (pch != NULL)
 ...
 * @return  parsed value. '0' if nothing to parse
 */         
uint32_t arduinoLoRaWAN::parseIntValue()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\n");
    if (pch != NULL)
 ...
 * @return  parsed value. '0' if nothing to parse
 */
float arduinoLoRaWAN::parseFloatValue()
{
    char * pch; 
    pch = strtok((char*) _buffer,"\r\n");
    if (pch != NULL)
